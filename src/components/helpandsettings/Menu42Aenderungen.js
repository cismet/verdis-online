...
import { colorNeededProof } from "../../utils/kassenzeichenHelper";
        ...
        <GenericModalMenuSection
            ...
            sectionContent={
                <div>
                    ...
                    <p style={{ color: colorNeededProof }}>
                        <strong>Achtung!:</strong> Änderungen können grundsätzlich nur dann
                        angenommen werden, wenn ein entsprechender Nachweis beigefügt wird. Wurde
                        eine Änderung vorgenommen, die sich gebührenreduzierend auswirkt, können
                        Änderungen nicht gespeichert und eingereicht werden. Bei dem Versuch
                        erscheinen entsprechende Meldungen. Flächen, die auf eine Messung eines
                        öffentlich bestellten Vermessungsingenieurs basieren, können auch nur durch
                        eine neuerliche Messung korrigiert werden.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        sollte geschehen, wenn Sie alle Änderungswünsche vorgenommen und eventuell
                        notwendige Nachweise abgelegt haben.
                    </p>
                    <p>
